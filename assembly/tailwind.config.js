    ...
    corePlugins: {
        ...
        extend: {
            fontFamily: {
                ...
                'custom': '0px 10px 100px 0px #5200FF',
                'custom-hover': '0px 20px 100px 0px #18299BB6',
            }, screens: {
                tablet: '768px', tabletMax: '1020px', desktop: '1200px', desktopMax: '1920px',
            }, viewport: {
                mobile: 320, tablet: 991, desktop: 1920,
            }, flex: {
                'header': '0 0 auto', 'main': '1 0 auto', 'footer': '0 0 auto',
            },
        }
    }, plugins: [require('tailwind-scrollbar-hide'),require('tailwindcss'), require('autoprefixer'), require('cssnano')({
        preset: 'default',
        ...
        matchUtilities({
            "aspect-ratio": (value) => {
                ...
                return {
                    ...
                    overflow: 'hidden',
                    '&::before': {
                        content: '""', display: 'block', width: '100%', paddingTop: `${(styles[1] / styles[0]) * 100}%`,
                    },
                ...
                const formulaTab = `calc(${styles[2]}px + ${styles[1] - styles[2]} * ((100vw - ${vwTab}px)/ ${vwDesk - vwTab}))`;
                const formulaMob = `calc(${styles[3]}px + ${styles[2] - styles[3]} * ((100vw - ${vwMob}px)/ ${vwTab - vwMob}))`;

                switch (styles[0]) {
                    case 'font':
                        if (!styles[3]) {
                            return {
                                fontSize: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    fontSize: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                fontSize: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                                    fontSize: `${formulaTab}`,
                                }, [`@media (min-width: ${vwDesk}px)`]: {
                                    fontSize: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                    ...
                    case 'w-max':
                        if (!styles[3]) {
                            return {
                                maxWidth: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    maxWidth: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                maxWidth: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                                    maxWidth: `${formulaTab}`,
                                }, [`@media (min-width: ${vwDesk}px)`]: {
                                    maxWidth: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                    ...
                    case 'w-min':
                        if (!styles[3]) {
                            return {
                                minWidth: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    minWidth: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                minWidth: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                                    minWidth: `${formulaTab}`,
                                }, [`@media (min-width: ${vwDesk}px)`]: {
                                    minWidth: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                    ...
                    case 'width':
                        if (!styles[3]) {
                            return {
                                width: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    width: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                width: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                                    width: `${formulaTab}`,
                                }, [`@media (min-width: ${vwDesk}px)`]: {
                                    width: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                    ...
                    case 'h-max':
                        if (!styles[3]) {
                            return {
                                maxHeight: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    maxHeight: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                maxHeight: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                    ...
                    case 'h-min':
                        if (!styles[3]) {
                            return {
                                minHeight: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    minHeight: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                minHeight: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                    ...
                    case 'height':
                        if (!styles[3]) {
                            return {
                                height: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    height: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                            return {
                                height: `${formulaMob}`, [`@media (min-width: ${vwTab}px)`]: {
                                    height: `${formulaTab}`,
                                }, [`@media (min-width: ${vwDesk}px)`]: {
                                    height: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                    ...
                    case 'pt':
                        if (!styles[3]) {
                            return {
                                paddingTop: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    paddingTop: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'pr':
                        if (!styles[3]) {
                            return {
                                paddingRight: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    paddingRight: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'pb':
                        if (!styles[3]) {
                            return {
                                paddingBottom: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    paddingBottom: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'pl':
                        if (!styles[3]) {
                            return {
                                paddingLeft: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    paddingLeft: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'mt':
                        if (!styles[3]) {
                            return {
                                marginTop: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    marginTop: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'mr':
                        if (!styles[3]) {
                            return {
                                marginRight: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    marginRight: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'mb':
                        if (!styles[3]) {
                            return {
                                marginBottom: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    marginBottom: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'ml':
                        if (!styles[3]) {
                            return {
                                marginLeft: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                                    marginLeft: `${(styles[1] / vwDesk) * 100}vw`,
                                },
                            };
                        } else {
                    ...
                    case 'gap':
                        if (!styles[3]) {
                            return {
                                gap: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'gap-x':
                        if (!styles[3]) {
                            return {
                                columnGap: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'gap-y':
                        if (!styles[3]) {
                            return {
                                rowGap: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'right':
                        if (!styles[3]) {
                            return {
                                right: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'left':
                        if (!styles[3]) {
                            return {
                                left: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'top':
                        if (!styles[3]) {
                            return {
                                top: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'bottom':
                        if (!styles[3]) {
                            return {
                                bottom: `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
                    ...
                    case 'svg-size':
                        return {
                            "svg": {
                                ...
                                [`@media (min-width: ${vwDesk}px)`]: {
                                    width: `${(styles[1] / vwDesk) * 100}vw`, height: `${(styles[3] / vwDesk) * 100}vw`,
                                },
                            },
                        };
                    case 'svg-width':
                    ...
                    case 'basis':
                        if (styles[3]) {
                            return {
                                ...
                                [`@media (min-width: ${vwDesk}px)`]: {
                                    'flex-basis': `${(styles[1] / vwDesk) * 100}vw`, 'flex-shrink': `${styles[3]}`
                                },
                            };
                        }

                        return {
                            'flex-basis': `${formula}`, [`@media (min-width: ${vwDesk}px)`]: {
