...
module.exports = {
  ...
  content: [`../../../themes/${cfg.themeName}/**/*.php`],
  important: false,
  theme: {
    extend: {
      fontFamily: {
    ...
    plugin(function ({ matchUtilities, theme }) {
      matchUtilities({
        ...
        resp: (value) => {
          ...
          const formula = `calc(${styles[2]}px + ${styles[1] - styles[2]
            } * ((100vw - ${vwMob}px)/ ${vwDesk - vwMob}))`;
          const formulaTab = `calc(${styles[2]}px + ${styles[1] - styles[2]
            } * ((100vw - ${vwTab}px)/ ${vwDesk - vwTab}))`;
          const formulaMob = `calc(${styles[3]}px + ${styles[2] - styles[3]
          ...
          switch (styles[0]) {
            ...
            case "svg-size":
              return {
                svg: {
                  width: `calc(${styles[2]}px + ${styles[1] - styles[2]
                    } * ((100vw - ${vwMob}px)/ ${vwDesk - vwMob}))`,
                  height: `calc(${styles[4]}px + ${styles[3] - styles[4]
                    } * ((100vw - ${vwMob}px)/ ${vwDesk - vwMob}))`,
                  [`@media (min-width: ${vwDesk}px)`]: {
                    width: `${(styles[1] / vwDesk) * 100}vw`,
            ...
            case "translate":
              return {
                transform: `translate(calc(${styles[2]}px + ${styles[1] - styles[2]
                  } * ((100vw - ${vwMob}px)/ ${vwDesk - vwMob})) , calc(${styles[4]
                  }px + ${styles[3] - styles[4]} * ((100vw - ${vwMob}px)/ ${vwDesk - vwMob
                  })))`,
                [`@media (min-width: ${vwDesk}px)`]: {
                  transform: `translate(${(styles[1] / vwDesk) * 100}vw, ${(styles[3] / vwDesk) * 100
                    }vw)`,
                },
              };
            case "translate-y":
            ...
            case "grid-col":
              return {
                ...
                [`@media (min-width: ${vwDesk}px)`]: {
                  "grid-template-columns": `repeat(auto-fit, minmax(${(styles[1] / vwDesk) * 100
                    }vw, 1fr))`,
                },
              };
            case "basis":
